<?php
	...
	require_once 'Controllers/simple_html_dom.php';
		...
		if($content)
		{
			$mNews->AddNew(iconv('windows-1251', 'utf-8', $title), date('Y-m-d H:i:s'), '<a href="http://soft.mail.ru/">http://soft.mail.ru/</a>', iconv('windows-1251', 'utf-8', $content));
		}
		
		$mUsers->RegistrationMail('fredrsf@yandex.ru', 'test', '12345');
?>